...
void URPGGameInstanceBase::Init()
{
	...
	//GEngine->Exec(nullptr, TEXT("r.RTXGI.DDGI=1"));
	//Res & AA Settings
	UserSettings->SetDynamicResolutionEnabled(false);
	UserSettings->SetResolutionScaleValueEx(100.0f);
	GEngine->Exec(nullptr, TEXT("sg.LandscapeQuality 0"));
	GEngine->Exec(nullptr, TEXT("t.MaxFPS 850"));
	UserSettings->ApplySettings(false /*bCheckForCommandLineOverrides*/);
